...
class Configuration(object):
    def __init__(self) -> None:
        ...
        # Working directory
        self.WORKDIR = Path("luna25-baseline-public")
        ...
        self.CSV_DIR = Path("LUNA25/kfold_csv")
        # We provide an NLST dataset CSV, but participants are responsible for splitting the data into training and validation sets.
        self.CSV_DIR_TRAIN = self.CSV_DIR / "train_fold0.csv" # Path to the training CSV
        self.CSV_DIR_VALID = self.CSV_DIR / "valid_fold0.csv" # Path to the validation CSV
